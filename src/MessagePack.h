...
enum Notification
{
	KILL = 100, DISPOSE_ME_REQUEST, PLAYER_1_DEAD, BOOST_OBTAINED_JUMP, BOOST_OBTAINED_SPEED, BOOST_USED,
};

enum BoostType
{
	NONE = 1000, CHANGE_LENGHT, BOOST_SPEED, BOOST_JUMP,
};

enum Player
{
	PLAYER_1 = 10000, PLAYER_2, PLAYER_3, PLAYER_4, PLAYER_NONE
};
