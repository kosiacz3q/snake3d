...
void RotaryCounter::init(){
	tex[0].loadTextureFromFile("/home/lucas/Workspace/Snake3d/tex/tex_0.png");
	tex[1].loadTextureFromFile("/home/lucas/Workspace/Snake3d/tex/tex_1.png");
	tex[2].loadTextureFromFile("/home/lucas/Workspace/Snake3d/tex/tex_2.png");
	tex[3].loadTextureFromFile("/home/lucas/Workspace/Snake3d/tex/tex_3.png");
	tex[4].loadTextureFromFile("/home/lucas/Workspace/Snake3d/tex/tex_4.png");
	tex[5].loadTextureFromFile("/home/lucas/Workspace/Snake3d/tex/tex_5.png");
	tex[6].loadTextureFromFile("/home/lucas/Workspace/Snake3d/tex/tex_6.png");
	tex[7].loadTextureFromFile("/home/lucas/Workspace/Snake3d/tex/tex_7.png");
	tex[8].loadTextureFromFile("/home/lucas/Workspace/Snake3d/tex/tex_8.png");
	tex[9].loadTextureFromFile("/home/lucas/Workspace/Snake3d/tex/tex_9.png");
...
void RotaryCounter::update(int mili){
	for(int i = 0; i < countOfSections; ++i){
		if(sections[i]. numberToReach != sections[i].actualNumber){
			...
			if( ( sections[i]. numberToReach - sections[i]. actualNumber) <= 0
					&&
					( sections[i]. numberToReach - sections[i]. actualNumber) > -1 ){
